        ...
        <div className="container" style={{ marginTop: '5%' }}>
            <div className="signup-grid">
                ...
                <div className="signup-text1" style={{ textAlign: 'left' }}>
                    Already a member? <span><Link to="/Login" style={{ color: 'rgb(33, 144, 255)' }}> Login</Link></span>
                </div>
                <div className="signup-form">
                    <form method="POST" onSubmit={register}>
                        ...
                        <div className="form-group">
                            ...
                            <input value={phone} onChange={(e) => setPhone(e.target.value)} type="tel" name="phone" id="phone" required className="form-control" placeholder="Enter your phone number" aria-describedby="helpId" pattern=".{10}" title="Phone number should be 10 numbers" />
                        </div>
